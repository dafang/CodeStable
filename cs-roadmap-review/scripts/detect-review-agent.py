#!/usr/bin/env python3
"""Detect optional independent reviewer capabilities for cs-roadmap-review."""
...
def build_result() -> dict[str, object]:
    ...
    if paseo_cli or health.get("ok"):
        ...
        reason = "Direct agent CLIs exist, but cs-roadmap-review should not invoke them automatically."
    else:
        mode = "local-review"
